...
class UpdatePostTool extends AbstractTool {
	...
	public function getDescription(): string {
		return 'Updates an existing content item. Only provided fields are changed.'; }
	...
	public function execute( array $arguments = array(), array $context = array() ): mixed {
		...
		try {
			...
			return $this->errors->notFound( $e->getMessage() ); } catch ( AccessDeniedException $e ) {
			return $this->errors->forbidden( $e->getMessage() ); } catch ( \Throwable $e ) {
				return $this->errors->create( 'update_failed', $e->getMessage() ); }
	}
}
