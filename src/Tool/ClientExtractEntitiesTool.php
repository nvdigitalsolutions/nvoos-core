...
class ClientExtractEntitiesTool extends AbstractClientSideTool {
	...
	public function getName(): string {
		return 'Extract Entities (Client)'; }
	public function getDescription(): string {
		return 'Extracts named entities (people, places, orgs) from text using Transformers.js. Runs client-side.'; }
	...
	public function execute( array $arguments = array(), array $context = array() ): mixed {
		...
		return $this->success(
			'Entity extraction will run in the browser using Transformers.js.',
			array(
				'client_side' => true,
