<?php
/**
 * Create Cron Job tool — schedules a single or recurring background task.
 *
 * Framework-agnostic equivalent of WP_MCP_AI_Tool_Create_Cron_Job.
 * Uses QueueClientInterface for scheduling instead of raw WP-Cron hooks.
 *
 * @package Nvoos\Core
 * @since   2.0.0
 * @license MIT
...
class CreateCronJobTool extends AbstractTool {
	...
	public function getDescription(): string {
		return 'Schedules a background task for a given hook, schedule, and arguments.';
	}
